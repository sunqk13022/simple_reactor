...
//  loop.RunAfter(3.5, boost::bind(print, "once3.5"));
  ...
  //TimerId td_id = loop.RunEvery(2, boost::bind(print, "every2"));
//  loop.RunEvery(3, boost::bind(print, "every3"));
  //loop.RunEvery(10, boost::bind(&EventLoop::Cancel, &loop, td_id));
  cancel_id = loop.RunEvery(5, cancelSelf);
